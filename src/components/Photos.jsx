    ...
    return (
        <div className='container' id='photos'>
            <div id="carouselExampleCaptions" className="carousel slide">
                ...
                <div className="carousel-inner" id= "photos">
                    <div className="carousel-item active">
                        <img src= {(props.data && props.data[0].urlToImage) ? props.data[0].urlToImage : "https://source.unsplash.com/random/300×300/?cricket"} className="d-block w-100" alt="..." />
                    ...
                    <div className="carousel-item">
                        <img src= {(props.data && props.data[1].urlToImage) ? props.data[1].urlToImage : "https://source.unsplash.com/random/300×300/?cricket"} className="d-block w-100" alt="..." />
                        <div className="carousel-caption d-none d-md-block">
                    ...
                    <div className="carousel-item">
                        <img src={(props.data && props.data[2].urlToImage ) ? props.data[2].urlToImage : "https://source.unsplash.com/random/300×300/?cricket"} className="d-block w-100" alt="..." />
                        <div className="carousel-caption d-none d-md-block">
                    ...
                    <div className="carousel-item">
                        <img src={(props.data && props.data[3].urlToImage) ? props.data[3].urlToImage : "https://source.unsplash.com/random/300×300/?cricket"} className="d-block w-100" alt="..." />
                        <div className="carousel-caption d-none d-md-block">
